  ...
  <div>
    ...
    <section class="section is-main-section">
      <tiles>
        <card-component :title="formCardTitle" icon="account-edit" class="tile is-child">
          <form @submit.prevent="submit">
            <b-field label="ID" horizontal>
              <b-input v-model="form.doctorantId" custom-class="is-static" readonly />
            </b-field>
            <hr>
            ...
            <b-field label="Lieu de naissance" message="Lieu de naissance" horizontal>
              <b-input placeholder="e.g. Sidi Bel Abbes" v-model="form.lieu_de_nissance" required />
            </b-field>
        ...
        <card-component v-if="isProfileExists" title="Ancien profile du doctorant" icon="account" class="tile is-child">
          ...
          <b-field label="Date et lieu de naissance" horizontal>
            <b-input :value="getdate(last.date_naissance) + ' - ' + last.lieu_de_nissance" custom-class="is-static" readonly/>
          </b-field>
        ...
        await axios
          ...
          .then(r => {
            ...
            if (item) {
              ...
              this.date_naissance = new Date(this.form.date_naissance)
            } else {
