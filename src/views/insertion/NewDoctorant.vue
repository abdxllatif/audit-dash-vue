<template>
  <div>
    ...
    <hero-bar>
      Insertion
      <router-link slot="right" to="/tables/doctorants" class="button">
        Table des doctorants
      </router-link>
    </hero-bar>
    <section class="section is-main-section">
      <card-component title="Nouveau doctorant" icon="ballot">
...
export default {
  ...
  methods: {
    submit () {
      this.isLoading = true
      axios.post('http://localhost:8090/api/data/doctorants', {
        nom: this.form.titre,
