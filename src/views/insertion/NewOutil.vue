<template>
  <div>
    ...
    <hero-bar>
      Insertion
      <router-link slot="right" to="/tables/outils" class="button">
        Table des outils
      </router-link>
    </hero-bar>
    <section class="section is-main-section">
      <import-component link="http://localhost:8090/api/data/outils/file"/>
      <card-component title="Nouveau outil" icon="ballot">
        <form @submit.prevent="submit">
          <b-field label="Nom de l'outil" horizontal>
            <b-field>
              <b-input icon="account" v-model="form.name" placeholder="Nom de l'outil" name="name" required />
            </b-field>
          </b-field>
