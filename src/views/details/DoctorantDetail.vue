<template>
  <div>
    ...
    <hero-bar>
      {{ heroTitle }}
      <router-link slot="right" :to="{ name: 'newDoc' }" class="button">
        {{ heroRouterLinkLabel }}
      </router-link>
    </hero-bar>
    <section class="section is-main-section">
      <b-tabs>
            <b-tab-item label="Profil du doctorant" icon="account-details">
                ...
                <b-field label="Date et lieu de naissance" horizontal>
                  <b-input :value="getdate(form.data_naissance) + ' - ' + form.lieu_de_nissance" custom-class="is-static" readonly/>
                </b-field>
...
export default {
  ...
  computed: {
    ...
    heroTitle () {
      return 'Détails du doctorant ' + this.form.nom
    },
    heroRouterLinkLabel () {
        ...
        axios
          ...
          .then(r => {
            ...
            if (item) {
              ...
              this.depId = item.departementDepartementId
            } else {
